                  ...
                  <tr key={expense.id} className="hover:bg-muted/30 transition-all group">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex flex-col">
                        <span className="text-text font-bold group-hover:text-primary transition-colors truncate max-w-[240px]" title={expense.description}>{expense.description}</span>
                      ...
                      {expense.category_name && (
                        <div className="flex flex-col gap-1 items-start">
                          ...
                          {expense.subcategory_text && (
                            <span className="text-[10px] text-muted font-semibold">{expense.subcategory_text}</span>
                          )}
                        </div>
                      )}
                    </td>
                    <td className="px-6 py-5 text-center">
                      <span className="text-text font-medium text-xs">{expense.payment_mode || '-'}</span>
                    </td>
                    <td className="px-6 py-5 text-center">
                      <span className="text-text font-medium text-xs">{expense.quantity ? `${expense.quantity} ${expense.unit || ''}` : '-'}</span>
                    </td>
